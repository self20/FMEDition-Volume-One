...
if($staff===false){
    ...
    $htmlout .= "<tr><td class='colhead'>{$lang['text_none']}</td></tr></table>";
    return;
}
    $counter = count($staff);
    ...
    $r = 0;
    $htmlout.= "<div class='headline'><div>{$staffclass}</div></div><div class='headbody'><table width='100%' border='0' cellpadding='3'>"; 
