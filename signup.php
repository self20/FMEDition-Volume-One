...
if ($i < 10){
    ...
    <table align='center' border='0' cellpadding='6' cellspacing='1' width='80%'>
    <tr>
    ...
    <td class='col1' align='left'><input type='password' size='40' name='passagain' /></td>
    </tr>
    ...
    <tr valign='top'>
    <td class='col1' align='right' class='rowhead'>{$lang['signup_email']}</td>
    <td class='col1' align='left'><input type='text' size='40' name='email' />
    ...
    <tr><td align='right' class='rowhead'>{$lang['signup_timez']}</td>
    <td class='col1' align='left'>{$time_select}</td></tr>
      <tr>
        <td class='col1'>&nbsp;</td>
        <td class='col1'>
          <div id='captchaimage'>
    ...
    <tr><td align='right' class='rowhead'></td><td class='col1' align='left'>
    ...
    <tr><td class='col1' colspan='2' align='center'>
    <input type='submit' value='{$lang['signup_btn']}' style='height: 25px' /></td></tr>
    </table>
    </form>";
