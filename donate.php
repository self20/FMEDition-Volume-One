...
loggedinorreturn();
	...
	<tr><td align='center' valign='middle' class='colhead'><h1>{$FMED['site_name']}</h1></td></tr>
	<tr><td class='col1' align='center' valign='middle' class='embedded'>
	<br /><br />
    ...
    <br />
    <tr>
    <td class='colhead' align='center' colspan='10' width='100%' style='text-align: center'>
    <tr><td align='center' valign='middle' class='colhead'><h1>{$FMED['site_name']}</h1></td></tr>
    </tr><tr><td width='100%' align='center' class='colhead' style='text-align: center'>
    <table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'>
    <tr>
    <td class='NONE' align='top' width='33%'>
    <br /><table align='center' cellpadding='4' cellspacing='1' border='0' style='width:90%'>
    <tr>
    <td class='NONE' align='center' colspan='10' width='100%' style='text-align: center'>
    <b><font color='#FFF'>One Week Subscription</b></font></td>
    ...
    <td  class='NON' align='top' width='33%'>
    <table align='center' cellpadding='4' cellspacing='1' border='0' style='width:90%'>
    <tr>
    <td class='NON' align='center' colspan='10' width='100%' style='text-align: center'><b>
    <b><font color='#FFF'>Two Week Subscription</b></font></td>
    </tr><tr><td bgcolor='#111111' width='100%' align='center' style='text-align: center'>
    ...
    <tr>
    <td class='NONE' align='center' colspan='10' width='100%' style='text-align: center'>
    <b><font color='#FFF'>Four Week Subscription</b></font></td>
    </tr><tr><td bgcolor='#111111' width='100%' align='center' style='text-align: center'>
    ...
    <table align='center' cellpadding='4' cellspacing='1' border='0' style='width:90%'>
    <tr>
    <td class='NON' align='center' colspan='10' width='100%' style='text-align: center'>
    <b><font color='#FFF'>Six Week Subscription</b></font></td>
    </tr><tr><td bgcolor='#111111' width='100%' align='center' style='text-align: center'>
    ...
    <tr>
    <td class='NON' align='center' colspan='10' width='100%' style='text-align: center'>
    <b><font color='#FFF'>Three Month Subscription</b></font></td>
    </tr><tr><td bgcolor='#111111' width='100%' align='center' style='text-align: center'>
    ...
    <tr>
    <td class='NON' align='center' colspan='10' width='100%' style='text-align: center'>
    <b><font color='#FFF'>Six Month Subscription</b></font></td>
    </tr><tr><td bgcolor='#111111' width='100%' align='center' style='text-align: center'>
    ...
    <tr>
    <td class='NON' align='center' width='33%'>
    ...
    <tr>
    <td class='NON' align='center' colspan='10' width='100%' style='text-align: center'>
    <b><font color='#FFF'>1 Year Subscription</b></font></td>
    </tr><tr><td bgcolor='#111111' width='100%' align='center' style='text-align: center'>
    ...
    <table align='center' cellpadding='4' cellspacing='1' border='0' style='width:90%'>
    <tr>
    <td class='col1' align='center' width='33%'>
