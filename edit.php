...
if (isset($_GET["returnto"]))
    ...
    $HTMLOUT  .=  "<table align='center' border='1' cellpadding='6' cellspacing='1' width='100%'>\n";
...
if (get_user_class() >= UC_MODERATOR){
    ...
    $HTMLOUT  .= "<tr><td  class='col1' colspan='2' align='center'>
    <input type='submit' value='{$lang['edit_submit']}' class='btn' />
    <input type='reset' value='{$lang['edit_revert']}' class='btn' /></td></tr>
    </table>
    </form>
    <br />
    <form method='post' action='delete.php'>
    <table align='center' border='1' cellpadding='6' cellspacing='1' width='100%'>
    <tr>
      <td class='embedded' style='background-color: #000;padding-bottom: 5px' colspan='2'><b>{$lang['edit_delete_torrent']}.</b> {$lang['edit_reason']}</td>
    </tr>
    <tr>
      <td class='rowhead' ><input name='reasontype' type='radio' value='1' />&nbsp;{$lang['edit_dead']} </td>
      <td class='col1'> {$lang['edit_peers']}</td>
    </tr>
    <tr>
      <td class='rowhead' ><input name='reasontype' type='radio' value='2' />&nbsp;{$lang['edit_dupe']}</td>
      <td class='col1'><input type='text' size='40' name='reason[]' /></td>
    </tr>
    <tr>
      <td class='rowhead' ><input name='reasontype' type='radio' value='3' />&nbsp;{$lang['edit_nuked']}</td>
      <td class='col1'><input type='text' size='40' name='reason[]' /></td>
    </tr>
    <tr>
      <td class='rowhead' ><input name='reasontype' type='radio' value='4' />&nbsp;{$lang['edit_rules']}</td>
      <td class='col1'><input type='text' size='40' name='reason[]' />({$lang['edit_req']})</td>
    </tr>
    <tr>
      <td class='rowhead' ><input name='reasontype' type='radio' value='5' checked='checked' />&nbsp;{$lang['edit_other']}</td>
      <td class='col1'><input type='text' size='40' name='reason[]' />({$lang['edit_req']})<input type='hidden' name='id' value='$id' /></td>
    </tr>";
if (isset($_GET["returnto"])){
    $HTMLOUT  .= "<input type='hidden' name='returnto' value='" . htmlspecialchars($_GET["returnto"]) . "' />\n";
}
    $HTMLOUT  .= "<tr><td  class='col1'colspan='2' align='center'>
    <input type='submit' value='{$lang['edit_delete']}' class='btn' /></td>
    </tr>
    </table>
    </form>";
