...
function begin_main_frame(){
    return "<table class='main' width='100%' border='0' cellspacing='0' cellpadding='0'>" ."<tr><td class='embedded'>\n";
}
...
if ($noesc)
    ...
    return "<tr><td class='rowhead' valign='top' align='right'>$x</td><td class=\"col1\"valign='top' align='left'>$a</td></tr>\n";
}
