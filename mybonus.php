...
if ((0 + $var) == 1)
    ...
    $HTMLOUT .= "<table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'><tr><td class='colhead' align='left' colspan='2'><h1>Success!</h1></td></tr><tr>
    <td class='clearalt6' align='left'><img src='{$FMED['pic_base_url']}smilies/karma.gif' alt='good_karma' title='Good karma' /></td>
    ...
    $HTMLOUT .="<table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'><tr><td class='colhead' align='left' colspan='2'><h1>Success!</h1></td></tr>
    <tr><td align='left' class='clearalt6'><img src='{$FMED['pic_base_url']}smilies/karma.gif' alt='good_karma' title='Good karma' /></td><td align='left' class='clearalt6'>
    ...
    stdhead($CURUSER['username'] . "'s Karma Bonus Page");
    $HTMLOUT .="<table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'><tr><td class='colhead' align='left' colspan='2'><h1>Success!</h1></td></tr><tr><td align='left' class='clearalt6'>
    <img src='{$FMED['pic_base_url']}smilies/karma.gif' alt='good_karma' title='Good karma' /></td><td align='left' class='clearalt6'>
    ...
    stdhead($CURUSER['username'] . "'s Karma Bonus Page");
    $HTMLOUT .="<table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'><tr><td class='colhead' align='left' colspan='2'><h1>Success!</h1></td></tr><tr>
    <td align='left' class='clearalt6'><img src='{$FMED['pic_base_url']}smilies/karma.gif' alt='good_karma' title='Good karma' /></td><td align='left' class='clearalt6'>
    ...
    $HTMLOUT .="<table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'><tr><td class='colhead' align='left' colspan='2'><h1>Success!</h1></td></tr><tr>
    <td align='left' class='clearalt6'><img src='{$FMED['pic_base_url']}smilies/karma.gif' alt='good_karma' title='Good karma' /></td><td align='left' class='clearalt6'><b>Congratulations! </b> ".$CURUSER['username']." you
    ...
    stdhead($CURUSER['username'] . "'s Karma Bonus Page");
    $HTMLOUT .="<table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'><tr><td class='colhead' align='left' colspan='2'><h1>Huh?</h1></td></tr><tr><td align='left' class='clearalt6'>
    ...
    stdhead($CURUSER['username'] . "'s Karma Bonus Page");
    $HTMLOUT .="<table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'><tr><td class='colhead' align='left' colspan='2'><h1>Error</h1></td></tr><tr><td align='left' class='clearalt6'>
    <img src='{$FMED['pic_base_url']}smilies/cry.gif' alt='bad_karma' title='Bad karma' /></td><td align='left' class='clearalt6'><b>Sorry ".$CURUSER['username']."...</b>
    ...
    stdhead($CURUSER['username'] . "'s Karma Bonus Page");
    $HTMLOUT .="<table align='center' border='0' cellpadding='6' cellspacing='1' width='100%'><tr><td class='colhead' align='left' colspan='2'><h1>Oops!</h1></td></tr><tr><td align='left' class='clearalt6'>
    ...
    <td class="colhead" align="center">Trade</td></tr>';
    ...
    case ($gets['id'] == 5):
    $HTMLOUT .='<tr>
    <td class="colhead" align="left" class='.$class.'><h1><font color="#2682ff">'.$gets['bonusname'].'</font></h1>'.$gets['description'].'<br /><br />Enter the <b>Special Title</b> you would like to have '.$otheroption_title.' click Exchange! </td><td class="colhead" align="center" class='.$class.'>'.$gets['points'].'</td>';
    break;
    case ($gets['id'] == 7):
    $HTMLOUT .='<tr>
    ...
    case ($gets['id'] == 9):
    $HTMLOUT .='<tr>
    <td class="colhead" align="left" class='.$class.'><h1><font color="#2682ff">'.$gets['bonusname'].'</font></h1>'.$gets['description'].'</td><td class="colhead" align="center" class='.$class.'>min.<br />'.$gets['points'].'</td>';
    break;
    case ($gets['id'] == 10):
    ...
    default:
    $HTMLOUT .='<tr>
    <td class="colhead" align="left" class='.$class.'><h1><font color="#2682ff">'.$gets['bonusname'].'</font></h1>'.$gets['description'].'</td><td class="colhead" align="center" class='.$class.'>'.$gets['points'].'</td>';
}
