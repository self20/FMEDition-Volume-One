...
if ($newtopic)
    ...
    " ."
    <td class='col1' align='left' style='padding: 0px'>
...
if (mysqli_num_rows($res) != 1)
    ...
    $htmlout .= "<tr><td class='col1' colspan='2' align='center'><input type='submit' class='btn' value='{$lang['forum_functions_submit']}' /></td></tr>\n";
    $htmlout .= end_table();
    $htmlout .= "</form>\n";
