...
if ($pn == $pc){
    ...
    $HTMLOUT .= "<table border='0' cellspacing='0' cellpadding='0'><tr>
    <td class='forumscol' width='99%'>#$postid by $by at $added";
...
if (get_user_class() >= UC_MODERATOR)
    ...
    $HTMLOUT .= "</td><td class='forumscol' width='1%'><a href='#top'><img src='{$forum_pic_url}top.gif' border='0' alt='{$lang['forum_topic_view_top']}' /></a></td></tr>";
    $HTMLOUT .= "</table>\n";
...
if (mysqli_num_rows($res2) == 1){
    ...
    <td class='col1' width='150' align='center' style='padding: 0px'>" .($avatar ? $avatar : ""). "<br /><div>$member_reputation</div></td>
    <td class='col1' class='comment'>$body</td>
    </tr>\n";
    $HTMLOUT .= end_table();
    $postadd = $arr['added'];
...
if (get_user_class() >= UC_MODERATOR){
    ...
    <tr>
        <td class='rowhead' align='right'>{$lang['forum_topic_view_sticky']}</td>
    <td class='col1'>
    ...
    <tr>
        <td class='rowhead' align='right'>{$lang['forum_topic_view_set_locked']}</td>
    <td class='col1'>
    ...
    <tr>
        <td class='rowhead' align='right'>{$lang['forum_topic_view_rename']}</td>
    <td class='col1'>
    ...
    <tr>
        <td class='rowhead' align='right'>Move this thread to:&nbsp;</td>
    <td class='col1'>
...
if ($arr["id"] != $forumid && get_user_class() >= $arr["minclasswrite"])
    ...
    <tr>
        <td class='rowhead' align='right'>{$lang['forum_topic_view_delete_topic']}</td>
    <td class='col1'>
