...
if (mysqli_num_rows($res) == 1){
    ...
    $HTMLOUT .=  "<tr><td class='col1' style='align:left;'>
    ...
    " ."
    $subject</td></tr></table></td>
    <td class='col1' style='align:right;'>$replies</td>\n
    " ."
    <td class='col1' style='align:right;'>$views</td>
    <td class='col1' style='align:left;'>$lpauthor</td>\n
    " ."
    <td class='col1' style='align:left;'>$lpadded<br />by&nbsp;$lpusername<br /><a href='forums.php?action=viewtopic&amp;topicid=$topicid&amp;page=p$lppostid#$lppostid'>Last Post</a></td>\n";
    $HTMLOUT .=  "</tr>\n";
}
    $HTMLOUT .=  "</table>\n";
    $HTMLOUT .=  $menu;
