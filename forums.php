...
global $FMED, $CURUSER, $lang, $forum_pic_url;
    ...
    $htmlout .= "<div style='width:80%'><p style='text-align:right;'>
    <span class='btn'><a href='forums.php?action=search'>{$lang['forums_search']}</a></span>
    &nbsp;
    <span class='btn'><a href='forums.php?action=viewunread'>{$lang['forums_view_unread']}</a></span>
    &nbsp;
    <span class='btn'><a href='forums.php?action=catchup'>{$lang['forums_catchup']}</a></span></p></div>";
    $htmlout .="<table align='center' border='0' cellpadding='6' cellspacing='1' width='80%'>\n";
    $htmlout .= "<tr>
...
if ($npostcheck)
    ...
    $htmlout .= "<tr><td class='col1' style='text-align:left;'>
    "."
    ...
    $forumdescription</td>
    "."
    <td class='col1' style='text-align:right;'>$topiccount</td>
    "."
    <td class='col1' style='text-align:right;'>$postcount</td>
    " ."
    <td class='col1' style='text-align:left;'>$lastpost</td></tr>\n";
}
    $htmlout .= "</table>\n<br />\n";
